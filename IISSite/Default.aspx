        ...
        <div class="container-fluid">
            <div class="row">
                <div class="jumbotron">
                    ...
                    <p>
                        <asp:RadioButtonList runat="server" AutoPostBack="false" RepeatDirection="Horizontal">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p>
                        <asp:Label ID="errLabel" CssClass="bg-danger" runat="server"></asp:Label>
                    </p>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="tab-pane fade" id="pills-data" role="tabpanel" aria-labelledby="pills-data-tab">
                                <asp:UpdatePanel runat="server" RenderMode="Inline" UpdateMode="Conditional" ValidateRequestMode="Disabled">
                                    <ContentTemplate>
                                        ...
                                        <asp:Button OnClick="GetData_Click" ID="GetData" Text="Get SQL Data" runat="server" />
                                        <div class="card">
                                            <div class="card-body">
